...
//     const newReview = { user: "Guest", comment, stars: 4 };
...
//   // Get rating value safely - it might be an object or a number
//   const ratingValue = typeof product.rating === 'object' 
//     ? (product.rating?.average || 0) 
//     : (product.rating || 0);
  
//   const totalReviews = typeof product.rating === 'object'
...
//                       .fill()
//                       .map((_, j) => (
//                         <FaStar key={j} color={j < rev.stars ? "#FFD700" : "#ddd"} />
//                       ))}
//                   </div>
//                   <p>{rev.comment}</p>
//                 </motion.div>
